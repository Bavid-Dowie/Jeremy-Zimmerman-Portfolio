        ...
        <div className='projects'>
          <div
            ...
            <a href='http://webplayer-lite.surge.sh/main'>
              <img src='https://github.com/Bavid-Dowie/Jeremy-Zimmerman-Portfolio/blob/master/sc-player-screenshot.png?raw=true' alt='webplayer' />
            </a>
            <p className='appText'>
          ...
          <div id='col' className='project2'>
            <a href='http://uxwdi-sushizo.surge.sh/'><img src='https://github.com/Bavid-Dowie/Jeremy-Zimmerman-Portfolio/blob/master/sushi-zo-screenshot.png?raw=true' alt='Sushi Zo' />
            </a>
            <p className='appText'>
          ...
          <div id='col' className='project3'>
            <a href='https://iterator.surge.sh/'><img src='https://github.com/Bavid-Dowie/Jeremy-Zimmerman-Portfolio/blob/master/iterator-screenshot.png?raw=true' alt='Iterator' /></a>
            <p className='appText'>
          ...
          <div id='col' className='project4'>
            <a href='http://loopit.surge.sh/login'><img src='https://github.com/Bavid-Dowie/Jeremy-Zimmerman-Portfolio/blob/master/loopit-screenshot.png?raw=true' alt='LoopIt' /></a>
